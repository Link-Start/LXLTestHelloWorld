...
/// 没有点击事件
- (instancetype)initModelWithLeftImgName:(NSString *)leftImgName leftLabelStr:(NSString *)leftLabelStr rightLabelStr:(NSString *)rightLabelStr isMore:(BOOL)isMore;
/// 有点击事件
- (instancetype)initModelWithLeftImgName:(NSString *)leftImgName leftLabelStr:(NSString *)leftLabelStr rightLabelStr:(NSString *)rightLabelStr isMore:(BOOL)isMore itemClick:(void(^)(NSIndexPath *indexPath))itemClick;
